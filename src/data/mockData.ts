...
export const sportCenters: SportCenter[] = [
  {
    ...
    description: {
      ...
      en: "Wiru spordikeskus is a modern and diverse training environment that offers opportunities for enthusiasts of different levels – from beginners to advanced. The center supports an active lifestyle and creates an inspiring environment for physical activity.",
    },
