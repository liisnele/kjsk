...
const sports = [
  ...
  { id: "running", key: "running", centerIds: ["ahtme"], equipmentOptions: [], hourlyPrice: 5 },
  { id: "aerobics", key: "aerobics", centerIds: ["wiru", "spordihoone"], equipmentOptions: ["yogaMat", "music"], hourlyPrice: 8 },
  { id: "badminton", key: "badminton", centerIds: ["wiru", "spordihoone"], equipmentOptions: ["rackets", "shuttlecocks"], hourlyPrice: 12 },
  { id: "gym", key: "gym", centerIds: ["wiru", "spordihoone"], equipmentOptions: [], hourlyPrice: 6 },
  { id: "swimming", key: "swimming", centerIds: ["wiru"], equipmentOptions: ["kickboard", "goggles"], hourlyPrice: 7 },
  { id: "tennis", key: "tennis", centerIds: ["wiru", "spordihoone"], equipmentOptions: ["rackets", "balls"], hourlyPrice: 15 },
  { id: "basketball", key: "basketball", centerIds: ["wiru", "ahtme", "spordihoone"], equipmentOptions: ["ball"], hourlyPrice: 20 },
  { id: "volleyball", key: "volleyball", centerIds: ["wiru", "spordihoone"], equipmentOptions: ["ball", "net"], hourlyPrice: 18 },
  { id: "skating", key: "skating", centerIds: ["jaahall"], equipmentOptions: ["skates", "helmet"], hourlyPrice: 6 },
  { id: "hockey", key: "hockey", centerIds: ["jaahall"], equipmentOptions: ["stick", "helmet", "pads"], hourlyPrice: 25 },
];
