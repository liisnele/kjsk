...
export type PricingRuleWhereInput = {
  ...
  serviceId?: Prisma.StringFilter<"PricingRule"> | string
  price?: Prisma.FloatFilter<"PricingRule"> | number
  priority?: Prisma.IntFilter<"PricingRule"> | number
  months?: Prisma.IntNullableListFilter<"PricingRule">
  weekdays?: Prisma.IntNullableListFilter<"PricingRule">
  startMinute?: Prisma.IntNullableFilter<"PricingRule"> | number | null
  endMinute?: Prisma.IntNullableFilter<"PricingRule"> | number | null
  organizationType?: Prisma.StringNullableFilter<"PricingRule"> | string | null
}
...
export type PricingRuleScalarWhereWithAggregatesInput = {
  ...
  serviceId?: Prisma.StringWithAggregatesFilter<"PricingRule"> | string
  price?: Prisma.FloatWithAggregatesFilter<"PricingRule"> | number
  priority?: Prisma.IntWithAggregatesFilter<"PricingRule"> | number
  months?: Prisma.IntNullableListFilter<"PricingRule">
  weekdays?: Prisma.IntNullableListFilter<"PricingRule">
  startMinute?: Prisma.IntNullableWithAggregatesFilter<"PricingRule"> | number | null
  endMinute?: Prisma.IntNullableWithAggregatesFilter<"PricingRule"> | number | null
  organizationType?: Prisma.StringNullableWithAggregatesFilter<"PricingRule"> | string | null
}
...
export type PricingRuleCreateInput = {
  ...
  price: number
  priority?: number
  months?: Prisma.PricingRuleCreatemonthsInput | number[]
  weekdays?: Prisma.PricingRuleCreateweekdaysInput | number[]
  startMinute?: number | null
  endMinute?: number | null
  organizationType?: string | null
}
...
export type PricingRuleUpdateInput = {
  ...
  months?: Prisma.PricingRuleUpdatemonthsInput | number[]
  weekdays?: Prisma.PricingRuleUpdateweekdaysInput | number[]
...
export type PricingRuleCreatemonthsInput = {
  set: number[]
}

export type PricingRuleCreateweekdaysInput = {
  set: number[]
}

export type PricingRuleUpdatemonthsInput = {
  set?: number[]
  push?: number | number[]
}

export type PricingRuleUpdateweekdaysInput = {
  set?: number[]
  push?: number | number[]
}
...
export type PricingRuleOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "serviceId" | "price" | "priority" | "months" | "weekdays" | "startMinute" | "endMinute" | "organizationType", ExtArgs["result"]["pricingRule"]>
...
export interface PricingRuleFieldRefs {
  ...
  readonly serviceId: Prisma.FieldRef<"PricingRule", 'String'>
  readonly price: Prisma.FieldRef<"PricingRule", 'Float'>
  readonly priority: Prisma.FieldRef<"PricingRule", 'Int'>
  readonly months: Prisma.FieldRef<"PricingRule", 'Int[]'>
  readonly weekdays: Prisma.FieldRef<"PricingRule", 'Int[]'>
  readonly startMinute: Prisma.FieldRef<"PricingRule", 'Int'>
  readonly endMinute: Prisma.FieldRef<"PricingRule", 'Int'>
  readonly organizationType: Prisma.FieldRef<"PricingRule", 'String'>
}
