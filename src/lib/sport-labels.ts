...
const labels: Record<string, Record<Lang, string>> = {
  ...
  "ahtme-package-arena-gym-tennis-sauna": {
    et: "Kergejõustik + jalgpall + jõusaal + tennis + saun",
    en: "Athletics + football + gym + tennis + sauna",
    ru: "Легкая атлетика + футбол + тренажерный зал + теннис + сауна",
  },
  ...
  "ahtme-package-gym-tabletennis-sauna": {
    et: "Jõusaal + lauatennis + saun",
    en: "Gym + table tennis + sauna",
    ru: "Тренажерный зал + настольный теннис + сауна",
  },
  "ahtme-family-package": {
    et: "Perepakett: kergejõustik + lauatennis + tennis",
    en: "Family package: athletics + table tennis + tennis",
    ru: "Семейный пакет: легкая атлетика + настольный теннис + теннис",
  },
