...
const ahtmeServices = [
  { id: "ahtme-single-ticket", key: "Kergejõustik + jõusaal", icon: "T", hourlyPrice: 6, priceMin: 4, priceMax: 6 },
  { id: "ahtme-club-training-full", key: "Registreeritud treening: kergejõustikuareen 1/1", icon: "A", hourlyPrice: 30, priceMin: 22, priceMax: 30 },
  { id: "ahtme-club-training-half", key: "Registreeritud treening: kergejõustikuareen 1/2", icon: "A", hourlyPrice: 17, priceMin: 14, priceMax: 17 },
  { id: "ahtme-club-training-quarter", key: "Registreeritud treening: kergejõustikuareen 1/4", icon: "A", hourlyPrice: 10, priceMin: 8, priceMax: 10 },
  { id: "ahtme-club-training-aerobics", key: "Registreeritud treening: aeroobikasaal", icon: "A", hourlyPrice: 14, priceMin: 10, priceMax: 14 },
  { id: "ahtme-club-training-gym", key: "Registreeritud treening: jõusaal", icon: "J", hourlyPrice: 12, priceMin: 9, priceMax: 12 },
  { id: "ahtme-unregistered-event-hall", key: "Registreerimata üritus/võistlus: kergejõustikuhall", icon: "H", hourlyPrice: 80 },
  { id: "ahtme-unregistered-event-territory", key: "Registreerimata üritus/võistlus: hall ja territoorium", icon: "H", hourlyPrice: 90 },
  { id: "ahtme-registered-training-full", key: "Registreeritud treening: kergejõustikuareen 1/1", icon: "R", hourlyPrice: 28, priceMin: 20, priceMax: 28 },
  { id: "ahtme-registered-training-half", key: "Registreeritud treening: kergejõustikuareen 1/2", icon: "R", hourlyPrice: 15, priceMin: 12, priceMax: 15 },
  { id: "ahtme-registered-training-quarter", key: "Registreeritud treening: kergejõustikuareen 1/4", icon: "R", hourlyPrice: 8, priceMin: 6, priceMax: 8 },
  ...
  { id: "ahtme-registered-training-gym", key: "Registreeritud treening: jõusaal", icon: "J", hourlyPrice: 10, priceMin: 7, priceMax: 10 },
  { id: "ahtme-registered-event-hall", key: "Registreeritud üritus/võistlus: kergejõustikuhall", icon: "H", hourlyPrice: 60 },
  { id: "ahtme-registered-event-territory", key: "Registreeritud üritus/võistlus: hall ja territoorium", icon: "H", hourlyPrice: 80 },
  { id: "ahtme-school-pe-free", key: "Koolide liikumisõpe, treeningud ja üritused", icon: "K", hourlyPrice: 0 },
  { id: "ahtme-tennis-court", key: "Tennis", icon: "T", hourlyPrice: 10, priceMin: 5, priceMax: 10 },
  { id: "ahtme-volleyball-court", key: "Võrkpall", icon: "V", hourlyPrice: 10, priceMin: 5, priceMax: 10 },
  { id: "ahtme-badminton-court", key: "Sulgpall", icon: "S", hourlyPrice: 10, priceMin: 5, priceMax: 10 },
  { id: "ahtme-supported-club-training", key: "Toetatavate spordiklubide ja Jõhvi Spordikooli treeningud", icon: "R", hourlyPrice: 10 },
  { id: "ahtme-supported-prep-time", key: "Toetatavate spordiklubide võistluste ettevalmistamise aeg", icon: "P", hourlyPrice: 2 },
  { id: "ahtme-unregistered-prep-time", key: "Registreerimata võistluste ja ürituste ettevalmistamise aeg", icon: "P", hourlyPrice: 0 },
  { id: "ahtme-state-school-pe", key: "HTM hallatavate koolide kehaline kasvatus ja üritused", icon: "K", hourlyPrice: 15, priceMin: 10, priceMax: 15 },
  { id: "ahtme-city-event-free", key: "Kohtla-Järve Linnavalitsuse korraldatav võistlus/üritus", icon: "L", hourlyPrice: 0 },
  ...
  { id: "ahtme-package-arena-gym-tennis-sauna", key: "Pakett: areen, jalgpall, jõusaal, tennis ja saun", icon: "P", hourlyPrice: 25 },
  { id: "ahtme-package-volleyball-sauna", key: "Pakett: võrkpall ja saun", icon: "P", hourlyPrice: 20 },
  { id: "ahtme-package-gym-tabletennis-sauna", key: "Pakett: jõusaal, lauatennis ja saun", icon: "P", hourlyPrice: 20 },
  { id: "ahtme-family-package", key: "Perepakett: 2 täiskasvanut ja kuni 3 last", icon: "P", hourlyPrice: 12 },
  { id: "ahtme-sauna-small", key: "Saun", icon: "S", hourlyPrice: 10 },
  { id: "ahtme-sauna-gym", key: "Saun + jõusaal", icon: "S", hourlyPrice: 15 },
];
