...
const ahtmeServices = [
  ...
  { id: "ahtme-club-training-full", key: "Kergejõustikuareen", icon: "A", hourlyPrice: 28, priceMin: 20, priceMax: 30 },
  { id: "ahtme-club-training-half", key: "Kergejõustikuareen 1/2", icon: "A", hourlyPrice: 15, priceMin: 12, priceMax: 17 },
  { id: "ahtme-club-training-quarter", key: "Kergejõustikuareen 1/4", icon: "A", hourlyPrice: 8, priceMin: 6, priceMax: 10 },
  { id: "ahtme-club-training-aerobics", key: "Aeroobikasaal", icon: "A", hourlyPrice: 12, priceMin: 9, priceMax: 14 },
  { id: "ahtme-club-training-gym", key: "Jõusaal", icon: "J", hourlyPrice: 10, priceMin: 7, priceMax: 12 },
  ...
  { id: "ahtme-package-arena-gym-tennis-sauna", key: "Kergejõustik + jalgpall + jõusaal + tennis + saun", icon: "P", hourlyPrice: 25 },
  { id: "ahtme-package-volleyball-sauna", key: "Võrkpall + saun", icon: "P", hourlyPrice: 20 },
  { id: "ahtme-package-gym-tabletennis-sauna", key: "Jõusaal + lauatennis + saun", icon: "P", hourlyPrice: 20 },
  { id: "ahtme-family-package", key: "Perepakett: kergejõustik + lauatennis + tennis", icon: "P", hourlyPrice: 12 },
